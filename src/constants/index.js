...
export const clientReviews = [
  ...
  },
  {
    ...
    name: 'Sarah N',
    position: 'Professor',
    img: 'assets/sarah-nireekshana.jpg',
    review:
      'Bhoomika’s expertise in web development is truly impressive. She delivered a robust and scalable solution for our e-commerce site, and our online sales have significantly increased since the launch. Se’s a true professional! Fantastic work.',
  },
  {
    id: 3,
    name: 'Vineeth Kumar',
    position: 'Professor ',
    img: 'assets/vineeth-kumar.jpg',
    review:
      'I can’t say enough good things about Bhoomika. She was able to take our complex project requirements and turn them into a seamless, functional website. Her problem-solving abilities are outstanding.',
  },
  {
    id: 4,
    name: 'Smith',
    ...
    img: 'assets/t5_5.svg',
    review:
      'Bhoomika was a pleasure to work with. She understood our requirements perfectly and delivered a website that exceeded our expectations. Her skills in both frontend backend dev are top-notch.',
  },
];
...
export const myProjects = [
  ...
  },
  {
    ...
    href: 'https://carepulse-plus.vercel.app/',
  ...
  {
    title: 'LanguaSpeak - AI Language Translation',
    desc: 'Built with the latest Next.js and TypeScript, LinguaSpeak is an advanced voice translation tool. It allows users to speak into the microphone, translate the spoken text to another language, and playback the translation.',
    subdesc:
  ...
  {
    title: 'Xora - A Saas Website',
    desc: 'Xora is a Modern UI/UX SaaS website developed using React.js and Tailwind CSS that exemplifies modern UI/UX principles.',
    subdesc:
    ...
    href: 'https://xora-six-iota.vercel.app/',
    texture: '/textures/project/video6.mp4',
